		...
		},beforePageText:"第",afterPageText:"页 共 {pages}",displayMsg:"从 {from} 到 {to}条 共 {total} 条"};
		})(jQuery);
		(function($){
		function _93(_94){
		var _95=$(_94);
		...
		$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"请您输入必填内容.",invalidMessage:null,rules:{email:{validator:function(_39c){
		...
		},message:"请填写邮件地址"},url:{validator:function(_39d){
		...
		$.fn.calendar.defaults={width:180,height:180,fit:false,border:true,firstDay:0,weeks:["一","二","三","四","五","六","七"],months:["一","二","三","四","五","六","七","八","九","十","十一","十二"],year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date(),onSelect:function(date){
		}};
		})(jQuery);
		(function($){
		function init(_3fb){
		...
		$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{frozenColumns:undefined,columns:undefined,fitColumns:false,autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,loadMsg:"数据加载中, 请耐心等待...",rownumbers:false,singleSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_5e5,_5e6){
